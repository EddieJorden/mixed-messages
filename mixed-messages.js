const nounsArray = ['dog', 'cat', 'bench', 'car', 'office'];

const verbsArray = ['jump', 'move', 'act'];

const adjectivesArray = ['clean', 'amazing', 'perfect', 'literally'];
...
let generatedMessage = randomMessageGenerator(
	selectedAdjective,
	selectedNoun,
	selectedVerb
);
